...
<img src="binary-trees.png" alt="이진트리 그래프들" width="700">
...
<img src="binary-tree-array.png" alt="완전이진트리와 경사이진트리의 배열 인덱스 비교" width="500">

### 링크 표현법

포인터를 이용하여 부모노드가 자식노드를 가리키게 하는 방법이다.

<img src="binary-tree-link.png" alt="완전이진트리와 경사이진트리의 포인터 비교" width="500">
